-- Setting up the database 'passwords'
...
INSERT INTO account_credentials (username, password, email_address, user_id, site_id, comment) VALUES
  ('mirmir21', AES_ENCRYPT('GlFigurinOutMyPass21', @key_str, @init_vector), 'mir.hrv3@gmail.com', 1, 1, 'Please like and subscribe my brothas and sistas.'),
  ('M1RHRV', AES_ENCRYPT('pokemodder567654', @key_str, @init_vector), 'mir.hrv3@gmail.com', 1, 2, 'Im going to mod the very best, like no one ever was.'),
  ('Harvmeister', AES_ENCRYPT('F5q`f1K7@[N4=I+G7', @key_str, @init_vector), 'mirmir03@gmail.com', 1, 3, 'Nintendo is on top.'),
  ('Not_Amir03', AES_ENCRYPT('TheBinger2003', @key_str, @init_vector), 'kidharvey000000003@gmail.com', 1, 4, 'Streaming all day errday.'),
  ('ItsHarvey', AES_ENCRYPT('ajhhja7864jhaaha', @key_str, @init_vector), 'aharvey@hartford.edu', 1, 5, NULL),
  ('TheFewer27', AES_ENCRYPT('sn768473918375', @key_str, @init_vector), 'thefewer@real.com', 2, 1, 'I love watching videos on youtube.'),
